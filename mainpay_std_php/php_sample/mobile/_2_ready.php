...
$logPath = "/home/asiaski/public_html/data/app.log";         //디버그 로그위치 (리눅스)
...
$approvalUrl = "https://asiaski.org/mobile/_3_approval.php"; //변경 필수
/*결제창 close시 호출되는 상점URL (PG->가맹점)*/
$closeUrl = "https://asiaski.org/mobile/_3_close.php"; //변경 필수	
$customerName = "고객명";
