    ...
    <form name="fvisit" method="get" onsubmit="return fvisit_submit(this);">
        ...
        <div class="local_ov01 local_ov">
            ...
            <span class="btn_ov01"> <span class="ov_txt">사진대조</span><span class="ov_num">
                    <a href="<?php echo "sbak_photo_list.php?event_code=".$event_code; ?>"> <i class="fa fa-photo"></i>
                    </a>
                </span></span>
        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    $member_link = G5_ADMIN_URL . "/sbak_event_list_B06.php?sfl=MB_ID&stx=" . urlencode($row['MB_ID']) . "&sst=" . $row['EVENT_YEAR'] . "&get_payment=YC";
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td>
                        ...
                        <select name="THE_GENDER[<?php echo $i ?>]" style="width:100%"
                            ...
                            <option value="남자" <?php if($row['THE_GENDER'] == '남자') { echo "selected";}  ?>>남자</option>
                            <option value="여자" <?php if($row['THE_GENDER'] == '여자') { echo "selected";}  ?>>여자</option>
                        </select>
