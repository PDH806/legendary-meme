...
$g5['title'] = '스키 티칭1 시험 관리';


require "./sbak_T1_test_list_header.php"; //기본 헤더 갖고오기

$sort_url = G5_ADMIN_URL . "/sbak_T1_test_list_ski.php?sst={$sst}&sfl=T_where&stx=";

//해당 년도에 해당하는 데이터만  
$sql_search = " where (TEST_YEAR = {$sst} and TYPE = 1) ";
                    ...
                    <td align="right">
                      <form name="frm_toexcel" method="post" action="./sbak_T1_test_list_xls.php">
                        시험일 : <input type="date" name="from_date" size="20" value="<?php echo stripslashes($stx); ?>"  class="frm_input">  ~      
                         ...
                         <input type="hidden" name="to_sport" value="ski">      
