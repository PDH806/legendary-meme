        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    $member_link = G5_ADMIN_URL . "/sbak_event_list_B02.php?sfl=MB_ID&stx=" . urlencode($row['MB_ID']) . "&sst=" . $row['EVENT_YEAR'] . "&get_payment=YC";
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td rowspan="2">
                        <?php
                            echo ($row['PAY_METHOD'] == "CARD") ? "신용카드" : "타행이체";
                            ?>
                    </td>
