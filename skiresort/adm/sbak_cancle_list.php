...
$READY_API_URL = G5_THEME_URL . "/html/my_form/php_sample/pc/_9_cancel.php"; 
...
<head>
  ...
  <script type='text/javascript'>
    function payment_cancel() {
      var form = document.getElementById("MAINPAY_FORM");
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td>
							...
							<img src="<?php echo $mb_img_url ?>" width=100 alt="회원이미지">
					     	<?php } else { ?>
							<img src="<?php echo G5_THEME_URL . "/html/my_ksia/image/anonym.png"; ?>" width=100 alt="회원이미지">
					    	<?php } ?>
                        ...
                        <td>
                            ...
                            <input type="text" name="MEMBER_EMAIL[<?php echo $i ?>]"
                                ...
                                placeholder="이메일">
                            <input type="text" name="LICENSE_NO[<?php echo $i ?>]" value="<?php echo $row['LICENSE_NO']; ?>"
                        ...
                        <td>
                            <input type="text" name="AMOUNT[<?php echo $i ?>]" readonly value="<?php echo $row['AMOUNT']; ?>" <?php if ($row['PAYMENT_STATUS'] == 'C') {
                             ...
                             if ($row['PAYMENT_STATUS'] == 'Y') {
                                 ...
                                 $member_payment_status = "<span class='box_ksia_darkblue'>취소완료</span>";
                                 }        
                        ...
                        <td>
                            ...
                            <input type='radio' name='TRAN_STATUS[<?php echo $i ?>]' value='2' <?php if ($row['TRAN_STATUS'] == '2')
                                       echo "checked"; ?> <?php if ($row['PAYMENT_STATUS'] == 'C') {
                                        echo " disabled";
                                    } ?>>신청완료
                            <input type='radio' name='TRAN_STATUS[<?php echo $i ?>]' value='3' <?php if ($row['TRAN_STATUS'] == '3')
                                       echo "checked"; ?> <?php if ($row['PAYMENT_STATUS'] == 'C') {
                                        echo " disabled";
                                    } ?>>발급완료
                            <input type='radio' name='TRAN_STATUS[<?php echo $i ?>]' value='4' <?php if ($row['TRAN_STATUS'] == '4')
                                       echo "checked"; ?> <?php if ($row['PAYMENT_STATUS'] == 'C') {
                                        echo " disabled";
                                    } ?>>발송완료
                        ...
                        <?php if ($row['PAYMENT_STATUS'] == 'C') { echo "class='ksia_input_deleted' readonly"; }else{ echo "class='ksia_input'"; } ?>
...
//mainpay ----------------------------------------------
                  if ($row['PAYMENT_STATUS'] == "Y") {
                    ...
                    echo "<button type='button' class=\"btn  btn-danger btn-sm\" onclick='payment_cancel()'>취소</button></h6>";
