        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    $member_link = G5_ADMIN_URL . "/sbak_event_list_B07.php?sfl=MB_ID&stx=" . urlencode($row['MB_ID']) . "&get_payment=YC";
                ...
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td rowspan="2">
                            ...
                            <input type="checkbox" name="ENTRY_INFO_3[<?php echo $i ?>]" value="예" <?php if ($row['ENTRY_INFO_3'] == '예')
