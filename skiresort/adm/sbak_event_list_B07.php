        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    $member_link = G5_ADMIN_URL . "/sbak_event_list_B07.php?sfl=MB_ID&stx=" . urlencode($row['MB_ID']) . "&sst=" . $row['EVENT_YEAR'] . "&get_payment=YC";
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td rowspan="2">
                        <select name='ENTRY_INFO_4[<?php echo $i ?>]' style="width:120px" <?php if ($row['PAYMENT_STATUS'] == 'C') {
                            ...
                            <option value='생활체육지도자' <?php if ($row['ENTRY_INFO_4'] == '생활체육지도자') {
                                                            echo "selected";
                                                        } ?>>생활체육지도자</option>
                            <option value='전문스포츠지도사' <?php if ($row['ENTRY_INFO_4'] == '전문스포츠지도사') {
                                                            echo "selected";
                                                        } ?>>전문스포츠지도사</option>
                        </select>
                        <br>
