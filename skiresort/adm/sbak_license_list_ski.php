...
// $count_statistics = '<a href="./sbak_license_statistics.php?sports=ski" class="ov_listall">년도별통계</a>';
    ...
    <form name="fvisit" method="get" onsubmit="return fvisit_submit(this);">
        ...
        <div class="local_ov01 local_ov">
            ...
            <span class="btn_ov01"> <span class="ov_txt">티칭3 </span><span class="ov_num">
                    <?php echo number_format($T3_count) ?>명
                </span></span>
            ...
            <span class="btn_ov01"> <span class="ov_txt">티칭1 </span><span class="ov_num">
                    <?php echo number_format($T1_count) ?>명
                </span></span>
            <span class="btn_ov01"> <span class="ov_txt">엑셀다운</span><span class="ov_num">
                    <a href="sbak_license_list_xls.php?sports=ski"> <i class="fa fa-file-excel-o"></i> </a>
...
<form name="ksia_license_list" id="ksia_license_list" action="./sbak_license_list_update.php"
    ...
    <input type="hidden" name="sports" value="ski">
...
<a href="./sbak_license_add.php?sports=ski" class="btn btn_03">자격증 정보 추가하기</a> <br>
