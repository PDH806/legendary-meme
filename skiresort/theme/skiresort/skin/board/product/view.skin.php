	...
	<div class="prodWrap">
		<div class="prod02">
			...
			<h2 id="bo_v_title">
				...
				<div class="bo_v_cateView themeBgColor"><?php echo $view['ca_name']; // 분류 출력 끝 ?></div> 
				<?php } ?>
				<div><?php echo cut_str(get_text($view['wr_subject']), 70); ?></div> 
			</h2>
			<?php if ($view['wr_1']) { ?><div class="sbjB1"><?php echo $view['wr_1']?></div><?php } ?>
			<ul>
				<?php if ($view['wr_2']) { ?><li><?php echo nl2br($view['wr_2'])?></li><?php } ?>
			</ul>
		...
		<?php } else {?>
			<ul class="bigphoto">
				<li><a class="bigphotoNoimg"><img src="<?php echo G5_THEME_URL ?>/plugin/websiting/imageSpacer.php?w=100&h=100" alt="이미지 없음"><b><i class="fa fa-picture-o"></i></b></a></li>
			</ul>
		<?php } ?>
