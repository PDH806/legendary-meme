        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <h4 class="fw-bold py-3 mb-4"><?php echo $the_sports_kr; ?> 티칭1 BIB 등록 </h4>
                    ...
                    <div class="online_wrap">
                        <ul>
                            ...
                            <li> 엑셀에 기 등록되어 있는 입력양식을 변형시, 등록되지 않습니다. </li>
                    ...
                    <div class="new_excel">
                        ...
                        <div class="excel_info">
                            ...
                            <p>
                                <?php
                                if ($the_type == '1') {
                                    $the_excel = G5_THEME_URL . "/sbak_files/register_t1_excel_sk_bib.xls";
                                } else {
                                    $the_excel = G5_THEME_URL . "/sbak_files/register_t1_excel_sb_bib.xls";
                                }

                                ?>
                                <a href="<?php echo $the_excel; ?>"> <i class="fa fa-file-excel-o"></i> BIB 등록용 엑셀양식
                                    다운로드(Click)</a>.
                            </p>
                        </div>

                        <form name="fitemexcelup" id="fitemexcelup" class="row g-3" method="post"
                            action="./excel_input_bib.php" enctype="MULTIPART/FORM-DATA" autocomplete="off">
