        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <!-- <div style="float:right;"><a href="<?php echo G5_THEME_URL; ?>/html/my_form/excel_input_bib.php?t_code=<?php echo $t_code; ?>&sports=<?php echo $the_type; ?>"
                            style="color:red;">
                    ...
                    <div class="my_wrap">
                        ...
                        <table class="table-style-01">
                            ...
                            if ($_FILES['excelfile']['tmp_name']) {
                                ...
                                $error_msg_5 = "BIB번호는 숫자로만 입력되어야 합니다. 빈값일 경우 0번 처리됩니다. 엑셀자료를 확인해주세요.";
                                ...
                                and MEMBER_NAME = '{$the_mb_name}' and T_status = '77' and PAYMENT_STATUS = 'Y' limit 1) as CHK_EXIST";
                                    ...
                                    <td> <i class='fa fa-warning'></i></td><td><span>해당 ID와 이름에 매칭되는 응시자가 없습니다.</span></td></tr>";
                                                    ...
                                                    $sql2 = "select UID from {$apply_table_name} where T_code = '{$t_code}' and MEMBER_ID = '{$the_mb_id}' 
                                                    and MEMBER_NAME = '{$the_mb_name}' and T_status = '77' and PAYMENT_STATUS = 'Y' limit 1";
                                                    $result2 = sql_fetch($sql2);


                                                        $target_uid = $result2['UID'] ?? '';

                                                        $query = "update {$apply_table_name} set 
                                                        BIB_NO = {$bib_no} , BIB_YN = '{$bib_yn}' where UID = {$target_uid} ";
                                                        sql_query($query);
                                                        // echo $query;
