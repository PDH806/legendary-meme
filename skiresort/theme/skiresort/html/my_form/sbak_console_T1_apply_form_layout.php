...
<form name="fwrite" id="fwrite" action="./sbak_T1_apply_update.php" onsubmit="return fwrite_submit(this)" method="post">
				...
				<div class="card-body">
					...
					<div class="mb-3 row">
						...
						<div class="col-md-5">
							<dl>
								<dd>
									<input class="form-control" type="date" name="apply_start" id="apply_start" placeholder="시작일" value="">
									<span>~</span>
									<input class="form-control" type="date" name="apply_end" id="apply_end" placeholder="마감일" value="">
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="mb-3 row">
						...
						<div class="col-md-5">
							<dl>
								<dd>
									<input class="form-control" type="hidden" name="t_where" id="t_where" value="<?php echo $resort_no; ?>">
									<input class="form-control" type="text" name="resort_name" id="resort_name" readonly value="<?php echo $resort_name; ?>">
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="mb-3 row">
						...
						<div class="col-md-5">
							<dl>
								<dd>
									<input class="form-control" type="date" name="t_date" id="t_date" placeholder="검정일자를 입력하세요." value="">
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="mb-3 row">
						...
						<div class="col-md-5">
							<dl>
								<dd>
									<input class="form-control" type="number" name="limit_member" id="limit_member" value="" placeholder="숫자로만 입력" required>
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="mb-3 row">
						...
						<div class="col-md-5">
							<dl>
								<dd>
									<input class="form-control" type="time" name="t_time" placeholder="검정당일 집합시간을 입력하세요." value="">
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="mb-3 row">
						...
						<div class="col-md-5">
							<dl>
								<dd>
									<input class="form-control" type="text" name="t_meeting" placeholder="응시자들과 만날 장소를 입력하세요.(예 : 시계탑앞)" required>
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="mb-3 row">
						...
						<div class="col-md-10">
							<dl>
								<dd>
									<input class="form-check-input" type="checkbox" name="is_private" id="Is_private" value="Y" class="Is_private"> <label
										for="Is_private">비공개 (아이디로 신청자격 제한시 체크)</label><br class="sview">
					...
					<div class="mb-3 row" id="id_lists" style="display:none;">
						...
						<div class="col-md-12">
							<dl>
								<dd>
									<textarea style="width:100%" name="target_id_list" rows=6 placeholder="아이디(대소문자 구분)를 콤마로 구분하여 입력하세요."></textarea>
								</dd>
							</dl>
						</div>
					</div>
