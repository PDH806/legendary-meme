...
<div id="page-content">
    ...
    <div class="tab">
        <ul class="tabnav">
            <li><a href="#tab01">스키지도요원 티칭1</a></li>
            <li><a href="#tab02">스키지도요원 티칭2</a></li>
            <li><a href="#tab03">스키지도요원 티칭3</a></li>
        </ul>
        <div class="tabcontent">
            ...
            <div id="tab01">
                ...
                <div class="tc_set_1">
                    ...
                    <table class="table_simple_b">
                        <tr>
                            ...
                            <td class="table_bd_top_3">스키지도요원(티칭1)</td>
                        </tr>
                        <tr>
                            <th>자격의 종류</th>
                            <td>등록민간자격</td>
                ...
                <div class="tc">
                    <div class="btn_over"><a href="<?php echo G5_THEME_URL . "/html/my_form/sbak_console_T1_test_apply.php?sports=ski"; ?>" class="navy_btn">티칭1 접수하기</a></div>
                    <div class="btn_over"><a href="<?php echo G5_THEME_URL . "/html/my_form/sbak_console_T1_test.php?sports=ski"; ?>" class="navy_btn">접수확인 및 취소</a></div>
                </div>
            ...
            <div id="tab02">
                ...
                <div class="tc_set_1">
                    ...
                    <table class="table_simple_b">
                        <tr>
                            ...
                            <td style="border-top:3px solid black">스키지도요원(티칭2)</td>
                        </tr>
                        <tr>
                            <th>자격의 종류</th>
                            <td>등록민간자격</td>
                        ...
                        <tr>
                            <th>필기면제자</th>
                            <td>1. 직전 연도 스키지도요원 자격시험 필기 합격자 (신청페이지에서 자격 조회 가능) <br>
                                2. 생활스포츠지도사(생활체육지도자) 중 스키종목 자격자 (해당 자격 자료 파일 업로드 필수)
                            </td>
                        </tr>
                        <tr>
                            <th>실기면제자</th>
                            <td>1. 직전 연도 스키지도요원 자격시험 실기 합격자(신청페이지에서 자격 조회 가능) <br>
                                2. 전·현직 스키 국가대표 또는 상비군 출신인 자 (해당 자격 자료 파일 업로드 필수)
                            </td>
                        </tr>
                        <tr>
                            <th>필기 & 실기면제자</th>
                            <td>1. 전 · 현직 데몬스트레이터 출신인 자 (해당 자격 자료 파일 업로드 필수) <br>
                                2. 전문스포츠지도사(경기지도자) 중 스키종목 자격자
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="tc">
                    <div class="btn_over"><a href="<?php echo G5_THEME_URL . "/html/my_form/sbak_console_10.php?event_sort=B02"; ?>" class="navy_btn">티칭2 접수하기</a></div>
            ...
            <div id="tab03">
                ...
                <div class="tc_set_1">
                    ...
                    <table class="table_simple_b">
                        <tr>
                            <th style="border-top:3px solid black">자격명</th>
                            <td style="border-top:3px solid black">스키지도요원(티칭3)</td>
                        </tr>
                        <tr>
                            <th>자격의 종류</th>
                            <td>등록민간자격</td>
                ...
                <div class="tc">
                    <div class="btn_over"><a href="<?php echo G5_THEME_URL . "/html/my_form/sbak_console_10.php?event_sort=B03"; ?>" class="navy_btn">티칭3 접수하기</a></div>
                    <div class="btn_over"><a href="<?php echo G5_THEME_URL . "/html/my_form/sbak_console_04.php"; ?>" class="navy_btn">접수확인 및 취소</a></div>
                </div>
