...
$sql = "update 7G_SBT3_Schedules set 
Test_Year 	= '$Test_Year',
Skiresort 	= '$Skiresort',
...
if (mysqli_query($link, $sql)){echo "<script language='javascript'>alert('요청하신 일정변경이 완료되었습니다.');top.document.location.href = 'admin_sbt3_schedule_edit.html?No=$No'</script>";} 
