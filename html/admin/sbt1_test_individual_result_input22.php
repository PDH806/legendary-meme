...
$style_header = 'width:200px;font-size:13pt';
?>
...
<head>
	...
	<script type="text/javascript">
        function sum(){  //input 5개 자동더해서 total에 입력
			...
			var num4 = $('[name=Score4]').val();

            totalnum = Number(num1)+Number(num2)+Number(num3)+Number(num3);
...
<?php
    ...
    <div class='container' style='padding:0px'>
		...
		<br><br>
			<p align = 'center' style = 'align:center;font-size:35px;font-weight:600;'>스키 Lv.1 검정결과 등록 ($row[MEMBER_NAME]님 #$The_No)</p>
		<br><br><br>";
        ...
        <div class='col-lg-12'>
            ...
            <div class='row' style='padding:0px'>
 		       ...
 		       <div class='col-lg-12'>";
					...
					<td width = 220px align = center style = 'background-color:#919191;color:#FFFFFF;font-size:18px;'>레벨1 검정 결과등록</td><td></td></tr></table><br>";
				...
				echo "<div class='form-group' style='padding-left:10px'>
						<div class='input-group'>
  							<div class='input-group-prepend'>
								<button class='btn btn-vimeo' type='button' style = 'width:200px;font-size:13pt'>검정참석여부</button>
  							</div>
                ...
                <div class='form-group' style='padding-left:10px'>
						<div class='input-group'>
  							<div class='input-group-prepend'>
								<button class='btn btn-vimeo'  type='button' style = '$style_header'>스노우플라우틴</button>
  							</div>
                ...
                <div class='form-group' style='padding-left:10px'>
						<div class='input-group'>
  							<div class='input-group-prepend'>
								<button class='btn btn-vimeo' type='button' style = '$style_header'>스탬턴</button>
  							</div>
                ...
                <div class='form-group' style='padding-left:10px'>
						<div class='input-group'>
  							<div class='input-group-prepend'>
								<button class='btn btn-vimeo' type='button' style = '$style_header'>베이직롱턴</button>
  							</div>
                ...
                <div class='form-group' style='padding-left:10px'>
						<div class='input-group'>
  							<div class='input-group-prepend'>
								<button class='btn btn-vimeo' type='button' style = '$style_header'>베이직숏턴</button>
  							</div>
								<input class='form-control'  type='text' id = 'score4' value = '$row[T_Score4]' name='Score4' placeholder='종목4 점수' onkeyup='sum();'>
						</div>											
                </div>
