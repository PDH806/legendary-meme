<?php
    ...
    ******************************************************************************************/
	...
	$Skiresort_No		= $_POST["Skiresort"];		//스키장 번호
	...
	$approvalUrl = "https://www.skiresort.or.kr/pc/exam_approve.php";
	/*결제창 close시 호출되는 상점URL (PG->가맹점)*/
	$closeUrl = "https://www.skiresort.or.kr/pc/exam_app_close.php";
