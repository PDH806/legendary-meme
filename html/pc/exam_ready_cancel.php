<?php
     ...
     ******************************************************************************************
     ...
     - 리얼-URL : https://api-std.mainpay.co.kr 
		 							https://relay.mainpay.co.kr   
     - 개발-URL : https://test-relay.mainpay.co.kr 	 	 	 
	 */
    ...
    // $apiKey = "U1FVQVJFLTExMjQ1MjIwMjMwMTAyMTYwMDA0MzAxNzA5"; // <===real???
    ...
    ******************************************************************************************/
	...
	// $approvalUrl = "https://dev.skiresort.or.kr/pc/exam_approve.php";
	// /*결제창 close시 호출되는 상점URL (PG->가맹점)*/
	// $closeUrl = "https://dev.skiresort.or.kr/pc/exam_app_close.php";
	...
	* READY API 호출
	*****************************************************************************************/
	$READY_API_URL = $API_BASE." /v1/api/payments/payment/cancel";
	$result = "";
	$errorMessage = "";
	try{
