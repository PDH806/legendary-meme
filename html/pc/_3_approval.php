<?php
	...
	$PAY_query	= "SELECT * FROM 7G_License_Renew where AID = '$aid'";
...
//	$mbrNo = "107603";
	...
	*********************************************************************************/
	if($resultCode != "200"){		
		...
		$Result_Code = "결제실패";
		$TRAN_STATUS = "결제실패";
		$Pay_Update = "update 7G_License_Renew set refNo = '$refNo', TRAN_TIME = '$tranTime', APPROVAL_NO = '$applNo', PAYMENT_STATUS = '$Result_Code', TRAN_STATUS = '$TRAN_STATUS', cardNo = '$cardNo', issueCardName = '$issueCardName', acqCompanyNo = '$acqCompanyNo',acqCompanyName = '$acqCompanyName', AuthToken = '$authToken' where REF_NO = '$mbrRefNo'";
		...
		$Result_Code = "2";
		$TRAN_STATUS = "2";
		$Pay_Update = "update 7G_License_Renew set 
