	...
	<table class="type">
	    ...
	    <tbody>
		    ...
		    <tr>
		        ...
		        <td style="width:80px;">필수</td>
		        <td style="width:200px;text-align:left">
					<input type="text" name="GoodsName" maxlength="80" value="<?php echo $GoodsName ?>" placeholder=""/>
		        </td>
		    </tr>
		    ...
		    <tr>
		        ...
		        <td style="width:80px;">필수</td>
		        <td style="width:200px;text-align:left">
					<input type="text" name="BuyerName" maxlength="30" value=<? echo "$BuyerName"; ?> placeholder=""/>
		        </td>
		    </tr>
		    ...
		    <tr>
		        ...
		        <td style="width:80px;">필수</td>
		        <td style="width:200px;text-align:left">
					<input type="text" name="BuyerTel" maxlength="30" value=<? echo "$BuyerTel"; ?> placeholder="-없이"/>
		        </td>
		    </tr>
		    ...
		    <tr>
		        <th scope="row">무이자할부구분</th>
		        <td>CardInterest</td>
		        <td style="width:80px;color: #a3a3f0;">선택</td>
		        <td style="width:200px;text-align:left">
					<select name="CardInterest" class="selectbox">
						<option value="" selected>선택</option>
						<option value="0">0-일반</option>
						<option value="2">2-상점무이자</option>
					</select>
		        </td>
		    </tr>		    
