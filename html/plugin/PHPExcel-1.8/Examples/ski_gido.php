...
$filepath = "data/ski_gido_t2-2.xls";
...
foreach ($lines as $key => $line) {
    ...
    $sql = "insert into t_reserve set 
             idkey='500047', gd_seq='GD4496', sd_seq='sd{$seq}', rs_seq='rs{$seq}',
             license_num='{$item['A']}', rs_buyer_name='{$item['B']}' , rs_buyer_name_en='' ,     
             rs_buyer_idkey='{$item['D']}' , insert_idkey='{$item['D']}', /*,  sosok='{$item['E']}' ,*/
             rs_buyer_tel='{$item['E']}' /* , etc='{$item['I']}'*/ 
    ";
   //echo $sql.'<br>';
