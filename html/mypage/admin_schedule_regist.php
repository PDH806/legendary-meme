<?
	...
	(Auditor, Test_Year, Skiresort, Participate, Test_Date, Expired_Date, Time, Testfee, Manager_ID, Status) 
	VALUES ('$Auditor','$Test_Year','$Skiresort','$Participate','$Test_Date','$Expired_Date','$Time','$Testfee','$Login_User_ID', 0)";
	}
	else
	{
	$sql = "INSERT INTO 7G_".$category."_Schedules 
	...
	if ($category == 'T1'){$return_page = 'admin8_t1_schedule_list.html';}
	if ($category == 'T2'){$return_page = 'admin_t2_schedule_list.html';}
	if ($category == 'T3'){$return_page = 'admin_t3_schedule_list.html';}
	if ($category == 'SBT1'){$return_page = 'admin8_sbt1_schedule_list.html';}
