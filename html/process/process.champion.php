 ...
 */
 ...
 $sql = "select  GD_OPEN_DT from t_goods where gd_seq = '{$_POST['seq']}' ";
 ...
 */
 ...
 /*기술선수권대회 마감일
 $date4 = strtotime(date("20190211"));
 $date3 = strtotime(date("20190212"));
 $date2 = strtotime(date("20190213"));
 //$today = strtotime(date("20190214"));
*/
...
where {$_POST['kind']} = '{$_POST['kind_value']}' and RS_BUYER_PWD = '{$_POST['RS_BUYER_PWD']}' and GD_SEQ='{$_POST['seq']}' order by a.rs_date desc limit 1";
 ...
 if($_POST['t2Chk']) $sql_common = ", RS_RESERVE_CHANNEL='티칭2 자격자' ";
 ...
 $sql = "INSERT INTO  t_reserve SET
            ...
            RS_BUYER_DOC='$db_ins_file', INSERT_IDKEY='$rs_buyer_idkey' , etc='{$_POST['skill']}'  {$sql_common} 
";
  sql_query($sql);
  //echo $sql;exit;
 }
 ...
 if(!$chk['cnt']){
   ...
   $sql_common = ", ADD_NICK_NAME='{$_POST['nickname']}', ADD_ABILITY='{$_POST['ability']}', ADD_HOBBY='{$_POST['hobby']}', ADD_SEX='{$_POST['apt_gender']}',
                 ADD_INTRODUCTION='{$_POST['introduction']}'  ";
 $sql = "INSERT INTO  t_reserve_add_info SET
            IDKEY='{$_POST['key']}', GD_SEQ='{$_POST['seq']}', RS_SEQ='{$_POST['OID']}', ADD_BIRTH='{$rs_buyer_idkey}', 
            ADD_NAME_KOR='{$_POST['hname']}', ADD_NAME_ENG='{$_POST['ename']}', ADD_TEL='{$tel}',
            ...
            REGIST_DATE = '".G5_TIME_YMDHIS."' {$sql_common}
";
  sql_query($sql);
 }
                            ...
                            <div class="tab_wrap">
                                <div class="accept_wrap menu">
                                    <div class="tab_menu_area inner_menu">
                                        ...
                                        <!--<? if(/*1==1*/$expiry && $r['RS_STATUS'] != 'D'){?>
                                            <li ><a href="javascript:frm2.action='../champion_accept_update.html';frm2.submit(); ">접수수정</a></li>
                                            <li class='on'><a href='javascript:void(0)'>결제확인 / 취소</a></li>
                                        <?php }else{?>
                                            <li><a href="javascript:alert('신청기간이 아닙니다.')">접수수정</a></li>
                                            <li class='on'><a href="javascript:alert('신청기간이 아닙니다.')">결제확인 / 취소</a></li>
                                        <?php }?>
                                        -->
                                        <li ><a href="javascript:frm2.action='../champion_accept_update.html';frm2.submit(); ">접수수정</a></li>
                                            <li class='on'><a href='teach_champion.html'>결제확인 / 취소</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/tab_menu_area-->
                                    ...
                                    <div class="tab1">
                                        <div class="patrol_list">
                                            <div class="content_box">
                                                <div class="txt_box">
                                                    <div class="tit_box"><span class="sb_tit">기술선수권대회&nbsp;신청 결제내역</span></div>
                                                        ...
                                                        <fieldset>
                                                            <table class="accept_table">
                                                               ...
                                                               <?php 
                                                                ...
                                                                if(abs($r['remain'])){ echo " <span style='color:red'> [취소금액:  ".number_format(abs($r[remain]))."원] </span>"; }
                                                                ?></span>
                                                                        </td>
                                                                    </tr>
                                                                    <?php if($_POST['kind']){ ?>
                                                                        ...
                                                                        <td>
                                                               				<div>
                                                               				 <form name='f1' action='post' onsubmit='return chkF1(this)'>
                                                               				  <input type='hidden' name='oAmount' value='<?php echo $r1['rs_buyer_amount']?>' />
