 ...
 */
 ...
 /*스키지도T3 마감일
 $date4 = strtotime(date("20190213"));
 $date3 = strtotime(date("20190214"));
 $date2 = strtotime(date("20190215"));
 //$today = strtotime(date("20190216"));
 */
                            ...
                            <div class="tab_wrap">
                                <div class="accept_wrap menu">
                                    <div class="tab_menu_area inner_menu">
                                        ...
                                        <!-- <li><a href="javascript:frm2.action='../teach_accept_t3_update.html';frm2.submit();">접수수정</a></li> -->
                                        ...
                                        -->    
                                        <li><a href="javascript:frm2.action='../teach_accept_t3_update.html';frm2.submit();">접수수정</a></li>
                                            <li class='on'><a href='teach_data_3.html'>결제확인 / 취소</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/tab_menu_area-->
                                    ...
                                    <div class="tab1">
                                        <div class="patrol_list">
                                            <div class="content_box">
                                                <div class="txt_box">
                                                    <div class="tit_box"><span class="sb_tit">스키지도요원(티칭3) 신청 결제내역</span></div>
