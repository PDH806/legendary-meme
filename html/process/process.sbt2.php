 ...
 */
 ...
 /*기술선수권대회 마감일
 $date4 = strtotime(date("20190212"));
 $date3 = strtotime(date("20190213"));
 $date2 = strtotime(date("20190214"));
 //$today = strtotime(date("20190215"));
 */
...
where {$_POST['kind']} = '{$_POST['kind_value']}' and RS_BUYER_PWD = '{$_POST['RS_BUYER_PWD']}' and GD_SEQ='{$_POST['seq']}' order by a.rs_date desc limit 1";
 ...
 if(!$_POST['isChk1']) $sql_common = ", RS_RESERVE_CHANNEL='조회없음' ";
 else if($_POST['isChk1']=='NONE') $sql_common = ", RS_RESERVE_CHANNEL='면제대상 아님' ";
 else if($_POST['isChk1']=='NOTES') $sql_common = ", RS_RESERVE_CHANNEL='필기면제' ";
 else if($_POST['isChk1']=='PRACTICE') $sql_common = ", RS_RESERVE_CHANNEL='실기면제' ";
 else if($_POST['isChk1']=='BOTH') $sql_common = ", RS_RESERVE_CHANNEL='실기/필기면제' ";
 ...
 $sql = "INSERT INTO  t_reserve SET
            ...
            RS_BUYER_DOC='$db_ins_file', INSERT_IDKEY='$rs_buyer_idkey' , INSERT_DT='".G5_TIME_YMDHIS."', LICENSE_NUM='{$_POST['license_num']}', etc='{$_POST['re_issue']} {$sql_common}
";
  sql_query($sql);
  //echo $sql;exit;
 }
 ...
 $sql = "INSERT INTO  t_reserve_add_info SET
            ...
            ADD_ADDR1 = '{$_POST['addr1']}' ,  ADD_ADDR2='{$_POST['addr2']}' , ADD_BIKE='{$_POST['ADD_BIKE']}', ADD_EXEMPT_TYPE='{$_POST['except']}',
                                ...
                                <div class="accept_wrap menu">
                                    <div class="tab_menu_area inner_menu">
                                        ...
                                        <? if(/*1==1*/$expiry && $r['RS_STATUS'] != 'D'){?>
                                            <li><a href="javascript:frm2.action='../snow_accept_t2_update.html';frm2.submit();">접수수정</a></li>
                                    ...
                                    <div class="tab1">
                                        <div class="patrol_list">
                                            <div class="content_box">
                                                <div class="txt_box">
                                                    <div class="tit_box"><span class="sb_tit">스노보드 지도요원(티칭2) 신청 결제내역</span></div>
