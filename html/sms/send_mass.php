...
/****************** 전송정보 설정시작 ****************/
$sms['sender'] ="01040261483"; // 발신번호
$sms['rdate'] = '20200528'; // 예약일자 - 20161004 : 2016-10-04일기준
$sms['rtime'] = ''; // 예약시간 - 1930 : 오후 7시30분
$sms['testmode_yn'] = 'n'; // Y 인경우 실제문자 전송X , 자동취소(환불) 처리
$sms['msg_type'] = 'SMS'; // SMS(단문) , LMS(장문), MMS(그림문자)  = 필수항목
/****************** 전송정보 설정끝 ***************/

/****************** 아래는 500건 설정예제입니다.***************/
$msg = "[스키비디오티비]테스트입니다."; // 메세지 내용
for($i=1; $i < 2; $i++) {
	$sms['rec_'.$i] = '01028891483'.($i < 100 ? ($i < 10 ? '00'.$i : '0'.$i) : $i); // 수신번호_$i 번째  = 필수항목
