...
define('G5_SKI_PATH',       G5_PATH.'/'.G5_SKI);
...
define('G5_TIME_Y',         date('Y', G5_SERVER_TIME));
...
// 퍼미션
define('G5_DIR_PERMISSION',  0757); // 디렉토리 생성시 퍼미션
define('G5_FILE_PERMISSION', 0647); // 파일 생성시 퍼미션
...
// 합격자 내역 엑셀파일명
if($_REQUEST['kind']=='t1b') define("T_TITLE","티칭1(보드)");
/*else if*/
?>