    ...
    <?php for ($i=0; $i<count($list); $i++) { 
		...
		if(isset($thumb['src']) && $thumb['src']) {
			...
			$youtubeID1 = explode('/',$youtubeID); 
				...
				$img_content = '<i class="webzLatThumb" style="background-image:URL(//img.youtube.com/vi/'.$youtube_video_id.'/maxresdefault.jpg);"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w='.$thumb_width.'&h='.$thumb_height.'" class="youtubeImbBlank" alt=""></i>';
